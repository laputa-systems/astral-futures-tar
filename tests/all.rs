...
#[test]
fn unknown_typeflag_entry_payload_is_readable() {
    test_async(async {
...
#[test]
fn unterminated_pax_record_is_rejected() {
    test_async(async {
...
#[test]
fn unterminated_pax_extensions_iterator_stops_after_error() {
    test_async(async {
        let mut ar = Archive::new(tar!("diff-014-unterminated-pax.tar"));
...
#[test]
fn pax_only_accepts_local_pax_entries() {
    test_async(async {
        for entry_type in [
            EntryType::Regular,
            EntryType::Link,
...
#[test]
fn pax_only_rejects_raw_entries() {
    test_async(async {
...
#[test]
fn pax_only_accepts_bare_ustar_entries() {
    test_async(async {
...
#[test]
fn pax_only_accepts_selective_local_pax_entries() {
    test_async(async {
        let mut builder = Builder::new(Vec::new());
...
#[test]
fn pax_only_rejects_non_pax_headers() {
    test_async(async {
...
#[test]
fn pax_only_rejects_non_pax_typeflags() {
    test_async(async {
        for entry_type in [
...
#[test]
fn pax_only_rejects_non_octal_numeric_fields() {
    test_async(async {
        for (field, byte) in [
            ("mode", b'8'),
            ("uid", 0x80),
...
#[test]
fn pax_only_rejects_dangling_local_pax_headers() {
    test_async(async {
...
#[test]
fn pax_only_rejects_stacked_local_pax_headers() {
    test_async(async {
...
#[test]
fn pending_pax_record_at_archive_end_is_rejected() {
    test_async(async {
...
#[test]
fn pending_pax_record_does_not_cross_ignored_terminator() {
    test_async(async {
...
#[test]
fn pax_numeric_overrides_accept_decimal_digits() {
    test_async(async {
...
#[test]
fn pax_numeric_overrides_reject_sign_prefixes() {
    test_async(async {
        for pax in [
            b"11 size=+2\n".as_slice(),
            b"11 uid=+42\n".as_slice(),
...
#[test]
fn pax_owner_names_override_entry_metadata() {
    test_async(async {
        let mut builder = Builder::new(Vec::new());
...
#[test]
fn last_pax_owner_metadata_wins() {
    test_async(async {
...
#[test]
fn pax_long_owner_names_are_exposed_by_entry() {
    test_async(async {
...
#[test]
fn pax_empty_owner_names_are_rejected() {
    test_async(async {
...
#[test]
fn unknown_empty_local_pax_values_are_rejected() {
    test_async(async {
...
#[test]
fn unknown_nonempty_local_pax_values_are_accepted() {
    test_async(async {
...
#[test]
fn empty_global_pax_values_remain_visible() {
    test_async(async {
...
#[test]
fn pax_non_utf8_owner_names_are_exposed_as_bytes() {
    test_async(async {
...
#[test]
fn solaris_extended_header_applies_pax_path() {
    test_async(async {
        let mut builder = Builder::new(Vec::new());
...
#[test]
fn gnu_x_typeflag_is_not_a_solaris_pax_extension() {
    test_async(async {
        let mut builder = Builder::new(Vec::new());
...
#[test]
fn orphaned_gnu_sparse_pax_metadata_is_rejected() {
    test_async(async {
        let cases: &[&[u8]] = &[
...
#[test]
fn long_name_stops_at_first_nul() {
    test_async(async {
        let mut b = Builder::new(Vec::<u8>::new());
...
#[test]
fn sparse_continuation_partial_record_is_rejected() {
    test_async(async {
...
#[test]
fn pax_path_and_gnu_longname_are_rejected() {
    test_async(async {
        let mut builder = Builder::new(Vec::new());
...
#[test]
fn gnu_longname_and_later_pax_path_are_rejected() {
    test_async(async {
        let mut builder = Builder::new(Vec::new());
...
#[test]
fn pax_linkpath_and_gnu_longlink_are_rejected() {
    test_async(async {
        let mut builder = Builder::new(Vec::new());
...
#[test]
fn gnu_longlink_and_later_pax_linkpath_are_rejected() {
    test_async(async {
        let mut builder = Builder::new(Vec::new());
...
#[test]
fn gnu_long_pathname_stops_at_first_nul() {
    test_async(async {
        let mut builder = Builder::new(Vec::new());
...
#[test]
fn gnu_long_linkname_stops_at_first_nul() {
    test_async(async {
        let mut builder = Builder::new(Vec::new());
...
#[test]
fn empty_read_does_not_report_eof_for_nonempty_entry() {
    test_async(async {
...
#[test]
fn truncated_entry_reports_eof_while_reading_body() {
    test_async(async {
...
#[test]
fn nul_version_ustar_headers_are_rejected() {
    test_async(async {
        let mut builder = Builder::new(Vec::new());
...
#[test]
fn extension_typeflags_on_old_headers_are_rejected() {
    test_async(async {
...
#[test]
fn pax_typeflag_on_gnu_header_is_rejected() {
    test_async(async {
        let pax = b"17 path=pax-name\n";
        let mut builder = Builder::new(Vec::new());
        let mut header = Header::new_gnu();
...
#[test]
fn duplicate_pax_paths_use_last_value() {
    test_async(async {
        let mut builder = Builder::new(Vec::new());
...
#[test]
fn extended_sparse_data_position_skips_extension_headers() {
    test_async(async {
