...
#[cfg(unix)]
#[test]
fn directory_permissions_are_cleared() {
    test_async(async {
...
#[test]
fn malformed_pax_path_extension() {
    test_async(async {
...
#[cfg(unix)]
#[test]
fn symlink_dir_collision_does_not_chmod_external_dir() {
    test_async(async {
        use std::os::unix::fs::PermissionsExt;
